namespace TMP.WORK.AramisChetchiki
{
    ...
    public abstract class BaseFieldsCollection : Collection<string>, INotifyCollectionChanged, INotifyPropertyChanged
    {
        ...
        public BaseFieldsCollection(IEnumerable<Shared.Common.PlusPropertyDescriptor> plusPropertyDescriptors)
        {
            IList<string> items = this.Items;
            if (plusPropertyDescriptors != null && items != null)
            {
                foreach (Shared.Common.PlusPropertyDescriptor item in plusPropertyDescriptors)
                {
                    items.Add(item.Name);
                }
            }
        ...
        public Shared.Windows.Collections.PlusPropertyDescriptorsCollection ToPlusPropertyDescriptorsCollection()
        {
            Shared.Windows.Collections.PlusPropertyDescriptorsCollection result = new Shared.Windows.Collections.PlusPropertyDescriptorsCollection();

            IDictionary<string, Shared.Common.PlusPropertyDescriptor> dictionary = this.ModelType switch
            {
                Type t when t == typeof(Meter) => Utils.ModelHelper.MeterPropertiesCollection,
                Type t when t == typeof(ChangeOfMeter) => Utils.ModelHelper.ChangesOfMetersPropertiesCollection,
                Type t when t == typeof(ElectricitySupply) => Utils.ModelHelper.ElectricitySupplyPropertiesCollection,
                Type t when t == typeof(SummaryInfoItem) => Utils.ModelHelper.SummaryInfoItemPropertiesCollection,
    ...
    public sealed class MeterFieldsCollection : BaseFieldsCollection
    {
        ...
        public MeterFieldsCollection(IEnumerable<Shared.Common.PlusPropertyDescriptor> plusPropertyDescriptors)
            : base(plusPropertyDescriptors) { }

        public override Type ModelType => typeof(Meter);
    }
    ...
    public sealed class ChangesOfMetersFieldsCollection : BaseFieldsCollection
    {
        ...
        public ChangesOfMetersFieldsCollection(IEnumerable<Shared.Common.PlusPropertyDescriptor> plusPropertyDescriptors)
            : base(plusPropertyDescriptors) { }

        public override Type ModelType => typeof(DbModel.ChangeOfMeter);
    }
    ...
    public sealed class SummaryInfoFieldsCollection : BaseFieldsCollection
    {
        ...
        public SummaryInfoFieldsCollection(IEnumerable<Shared.Common.PlusPropertyDescriptor> plusPropertyDescriptors)
            : base(plusPropertyDescriptors) { }
