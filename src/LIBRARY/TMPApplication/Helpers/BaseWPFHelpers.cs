namespace TMPApplication.Helpers
{
    ...
    public class BaseWPFHelpers
    {
        ...
        public class FinderMatchType : IFinderMatchVisualHelper
        {
            ...
            private bool stopafterfirst = false;
            ...
            {
                return this.ty.IsInstanceOfType(item);
            }

            public bool StopAfterFirst
            {
                get => this.stopafterfirst;
                set => this.stopafterfirst = value;
            }
        }
        ...
        public class FinderMatchName : IFinderMatchVisualHelper
        {
            ...
            public bool DoesMatch(DependencyObject item)
            {
                ...
                {
                    if ((item as FrameworkElement).Name == this.name)
                    {
                        bMatch = true;
                    }
                }
