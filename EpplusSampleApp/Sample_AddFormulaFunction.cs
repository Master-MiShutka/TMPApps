namespace EPPlusSamples
{
    ...
    /// </summary>
    internal class Sample_AddFormulaFunction
    {
    ...
    internal class MyFunctionModule : IFunctionModule
    {
    ...
    /// </summary>
    internal class SumAddTwo : ExcelFunction
    {
    ...
    /// </summary>
    internal class TextSwedish : ExcelFunction
    {
        public override CompileResult Execute(IEnumerable<FunctionArgument> arguments, ParsingContext context)
        {
            // Sanity check, will set excel VALUE error if min length is not met
    ...
    /// </summary>
    internal class SeanConneryfy : ExcelFunction
    {
        public override CompileResult Execute(IEnumerable<FunctionArgument> arguments, ParsingContext context)
        {
            // Sanity check, will set excel VALUE error if min length is not met
