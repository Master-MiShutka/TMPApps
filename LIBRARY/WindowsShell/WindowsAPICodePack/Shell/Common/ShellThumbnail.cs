    ...
    public class ShellThumbnail
    {
        ...
        public System.Windows.Size CurrentSize
        {
            ...
            set
            {
                ...
                System.Windows.Size size = (this.FormatOption == ShellThumbnailFormatOption.IconOnly) ?
        ...
        /// Null is returned if the ShellObject does not have a thumbnail or icon image.
        /// </summary>
        public Icon Icon => Icon.FromHandle(this.Bitmap.GetHicon());

        /// <summary>
        /// Gets the thumbnail or icon in small size and <see cref="System.Drawing.Bitmap"/> format.
        /// </summary>
        public Bitmap SmallBitmap => this.GetBitmap(DefaultIconSize.Small, DefaultThumbnailSize.Small);
        ...
        /// </summary>
        public Icon SmallIcon => Icon.FromHandle(this.SmallBitmap.GetHicon());

        /// <summary>
        /// Gets the thumbnail or icon in Medium size and <see cref="System.Drawing.Bitmap"/> format.
        /// </summary>
        public Bitmap MediumBitmap => this.GetBitmap(DefaultIconSize.Medium, DefaultThumbnailSize.Medium);

        /// <summary>
        /// Gets the thumbnail or icon in medium size and <see cref="System.Windows.Media.Imaging.BitmapSource"/> format.
        /// </summary>
        public BitmapSource MediumBitmapSource => this.GetBitmapSource(DefaultIconSize.Medium, DefaultThumbnailSize.Medium);

        /// <summary>
        /// Gets the thumbnail or icon in Medium size and <see cref="System.Drawing.Icon"/> format.
        /// </summary>
        public Icon MediumIcon => Icon.FromHandle(this.MediumBitmap.GetHicon());

        /// <summary>
        /// Gets the thumbnail or icon in large size and <see cref="System.Drawing.Bitmap"/> format.
        /// </summary>
        public Bitmap LargeBitmap => this.GetBitmap(DefaultIconSize.Large, DefaultThumbnailSize.Large);

        /// <summary>
        /// Gets the thumbnail or icon in large size and <see cref="System.Windows.Media.Imaging.BitmapSource"/> format.
        /// </summary>
        public BitmapSource LargeBitmapSource => this.GetBitmapSource(DefaultIconSize.Large, DefaultThumbnailSize.Large);

        /// <summary>
        /// Gets the thumbnail or icon in Large size and <see cref="System.Drawing.Icon"/> format.
        /// </summary>
        public Icon LargeIcon => Icon.FromHandle(this.LargeBitmap.GetHicon());

        /// <summary>
        /// Gets the thumbnail or icon in extra large size and <see cref="System.Drawing.Bitmap"/> format.
        /// </summary>
        public Bitmap ExtraLargeBitmap => this.GetBitmap(DefaultIconSize.ExtraLarge, DefaultThumbnailSize.ExtraLarge);

        /// <summary>
        /// Gets the thumbnail or icon in Extra Large size and <see cref="System.Windows.Media.Imaging.BitmapSource"/> format.
        /// </summary>
        public BitmapSource ExtraLargeBitmapSource => this.GetBitmapSource(DefaultIconSize.ExtraLarge, DefaultThumbnailSize.ExtraLarge);

        /// <summary>
        /// Gets the thumbnail or icon in Extra Large size and <see cref="System.Drawing.Icon"/> format.
        /// </summary>
        public Icon ExtraLargeIcon => Icon.FromHandle(this.ExtraLargeBitmap.GetHicon());
        ...
        private IntPtr GetHBitmap(System.Windows.Size size)
        {
            ...
            HResult hr = ((IShellItemImageFactory)this.shellItemNative).GetImage(nativeSIZE, this.CalculateFlags(), out hbitmap);

            if (hr == HResult.Ok)
            {
                return hbitmap;
            }
            else if ((uint)hr == 0x8004B200 && this.FormatOption == ShellThumbnailFormatOption.ThumbnailOnly)
            {
