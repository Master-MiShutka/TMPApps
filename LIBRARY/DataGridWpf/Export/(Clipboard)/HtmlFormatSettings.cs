...
namespace DataGridWpf.Export
{
    public class HtmlFormatSettings : FormatSettingsBase
    {
        ...
        public string ExporterStartDelimiter { get; set; }

        public string ExporterEndDelimiter { get; set; }

        public string HeaderFieldStartDelimiter { get; set; }

        public string HeaderFieldEndDelimiter { get; set; }

        public string HeaderDataStartDelimiter { get; set; }

        public string HeaderDataEndDelimiter { get; set; }

        public string FieldStartDelimiter { get; set; }

        public string FieldEndDelimiter { get; set; }

        public string DataStartDelimiter { get; set; }
