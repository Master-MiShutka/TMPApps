...
namespace ExcelAddInBuh_Office2013.СуммаПрописью
{
    /// <summary>
    ...
    public static class Сумма
    {
        ...
        {
            if (сумма < 0) return "Сума не павінна быць адмоўнай.";
            ...
            {
                return "Сума павінна змяшчаць не больш за две лічбы пасля коскі.";
            }
