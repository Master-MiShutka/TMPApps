namespace JsonCSharpClassGenerator
{
    ...
    {
        public static T GetJToken<T>(JObject obj, string field)
            where T : JToken
        {
            JToken value;
        ...
        private static T GetJToken<T>(JToken token)
            where T : JToken
        {
            if (token == null)
            {
        ...
        public static object ReadObject(JToken token)
        {
            ...
            {
                return ReadArray<object>(value, ReadObject);
            }
        ...
        public static T ReadStronglyTypedObject<T>(JToken token)
            where T : class
        {
