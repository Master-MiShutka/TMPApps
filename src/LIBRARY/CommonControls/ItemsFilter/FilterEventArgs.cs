...
namespace TMP.Wpf.CommonControls.ItemsFilter {
    /// <summary>
    /// Provides information and event data that is associated with the TMP.Wpf.CommonControls.ItemsFilter.FilterPresenter.Filter event.
    /// </summary>
