...
{
    /// <summary>
    /// Класс, позволящий изменять тему окон и акцента
    /// </summary>
    public static class ThemeManager
    {
        ...
        /// <summary>
        /// Возвращает список всех тем по-умолчанию
        /// </summary>
        public static IEnumerable<Accent> Accents
        {
            get
            {
                ...
                {
                    _accents.Add(new Accent(color, new Uri(string.Format("pack://application:,,,/TMP.Wpf.CommonControls;component/Styles/Accents/{0}.xaml", color))));
                }
        ...
        /// <summary>
        /// Gets a list of all of default tmp themes.
        /// </summary>
        public static IEnumerable<AppTheme> AppThemes
        {
            get
            {
                ...
                {
                    var appTheme = new AppTheme(color, new Uri(string.Format("pack://application:,,,/TMP.Wpf.CommonControls;component/Styles/Accents/{0}.xaml", color)));
