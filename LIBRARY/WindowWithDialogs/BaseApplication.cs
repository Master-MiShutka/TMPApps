...
using NLog;
using WindowWithDialogs.Contracts;
...
namespace WindowWithDialogs
{
    public partial class BaseApplication : Application, INotifyPropertyChanged
    {
        ...
        /// Главное окно
        /// </summary>
        public Contracts.IWindowWithDialogs MainWindowWithDialogs
        {
            get
            {
                if (this.mainWindowWithDialogs == null && Current.MainWindow is Contracts.IWindowWithDialogs window)
                {
        ...
        public static MessageBoxResult ShowError(string message, MessageBoxButton buttons = MessageBoxButton.OK, Action? runAfter = null)
        {
            Func<MessageBoxResult> func = () =>
            {
                ...
                {
                    if (Current.MainWindow is Contracts.IWindowWithDialogs windowWithDialogs && windowWithDialogs.DialogManager != null)
                    {
