namespace WindowWithDialogs.WpfDialogs
{
    ...
    public class DialogManager : IDialogManager
    {
        ...
        public IMessageDialog? CreateMessageDialog(string message, DialogMode dialogMode, UIInfrastructure.MessageBoxImage image = UIInfrastructure.MessageBoxImage.None)
        {
        ...
        public IMessageDialog? CreateMessageDialog(string message, string caption, DialogMode dialogMode, UIInfrastructure.MessageBoxImage image = UIInfrastructure.MessageBoxImage.None)
        {
            IMessageDialog? dialog = null;
            this.InvokeInUIThread(() =>
            {
        ...
        public IProgressDialog? CreateProgressDialog(UIInfrastructure.DialogMode dialogMode, bool isIndeterminate = false)
        {
