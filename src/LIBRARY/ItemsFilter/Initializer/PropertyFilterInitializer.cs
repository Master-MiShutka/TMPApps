namespace ItemsFilter.Initializer
{
    ...
    public abstract class PropertyFilterInitializer : FilterInitializer
    {
        ...
        /// <summary>
        /// Create instance of PropertyFilter for  filterPresenter and propertyInfo, if it is possible.
        /// </summary>
        protected abstract PropertyFilter NewFilter(FilterPresenter filterPresenter, ItemPropertyInfo propertyInfo);
    }
}