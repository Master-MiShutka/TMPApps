namespace TMP.ExcelXml
{
    ...
    public partial class Worksheet : Styles, IEnumerable<Cell>
    {
        ...
        internal Worksheet(ExcelXmlWorkbook parent)
        {
            ...
            this._MergedCells = new List<Range>();
        ...
        internal Cell Cells(int colIndex, int rowIndex)
        {
            ...
            if (colIndex + 1 > this._Rows[rowIndex].Cells.Count)
            {
                for (int i = this._Rows[rowIndex].Cells.Count; i <= colIndex; i++)
                {
                    this._Rows[rowIndex].Cells.Add(new Cell(this._Rows[rowIndex], i));
                }
            }

            this.maxColumnAddressed = Math.Max(colIndex, this.maxColumnAddressed);

            return this._Rows[rowIndex].Cells[colIndex];
        }
        ...
        {
            foreach (Range range in this._MergedCells)
            {
        ...
        public void DeleteRows(Row row, int numberOfRows)
        {
            if (row != null)
            {
                this.DeleteRows(this._Rows.FindIndex(r => r == row), numberOfRows);
            }
        }
        ...
        public void DeleteRows(int index, int numberOfRows, bool cascade)
        {
            ...
            for (int i = index; i < (index + numberOfRows); i++)
            {
                foreach (Cell cell in this._Rows[i].Cells)
                {
                    cell.Empty();
                }
            }
        ...
        public void DeleteRows(Row row, int numberOfRows, bool cascade)
        {
            if (row != null)
            {
                this.DeleteRows(this._Rows.FindIndex(r => r == row), numberOfRows, cascade);
            }
        }
        ...
        public void DeleteRow(Row row)
        {
            if (row != null)
            {
                this.DeleteRow(this._Rows.FindIndex(r => r == row));
            }
        }
        ...
        public void DeleteRow(int index, bool cascade)
        {
            ...
            foreach (Cell cell in this._Rows[index].Cells)
            {
                cell.Empty();
            }
        }
        ...
        public void DeleteRow(Row row, bool cascade)
        {
            if (row != null)
            {
                this.DeleteRow(this._Rows.FindIndex(r => r == row), cascade);
            }
        }
        ...
        public void InsertRowsBefore(int index, int rows)
        {
            ...
            for (int i = index; i < (index + rows); i++)
            {
                ...
                this._Rows.Insert(index, newRow);
            }
        ...
        {
            this.InsertRowsBefore(this._Rows.FindIndex(r => r == row), rows);
        }
        ...
        {
            return this.InsertRowBefore(this._Rows.FindIndex(r => r == row));
        }
        ...
        public void InsertRowsAfter(int index, int rows)
        {
            ...
            for (int i = index; i < (index + rows); i++)
            {
                ...
                this._Rows.Insert(index + 1, newRow);
            }
        ...
        public void InsertRowsAfter(Row row, int rows)
        {
            if (row != null)
            {
                this.InsertRowsAfter(this._Rows.FindIndex(r => r == row), rows);
            }
        }
        ...
        {
            return this.InsertRowAfter(this._Rows.FindIndex(r => r == row));
        }
