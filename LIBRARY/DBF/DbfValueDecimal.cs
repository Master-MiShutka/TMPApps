namespace DBF
{
    ...
    public class DbfValueDecimal : DbfValue<decimal?>, IDbfValue<decimal>
    {
        ...
        decimal IDbfValue<decimal>.Value => this.Value.GetValueOrDefault();

        public override object Clone()
        {
            return new DbfValueDecimal(this.Length, this.DecimalCount);
        }
        ...
        private void Parse(string stringValue)
        {
            if (decimal.TryParse(stringValue,
                    ...
                    decimalNumberFormat, out var value))
            {
                this.Value = value;
            }
            else
