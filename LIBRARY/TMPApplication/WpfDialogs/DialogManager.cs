...
namespace TMPApplication.WpfDialogs
{
	public class DialogManager : IDialogManager
	{
        ...
        public IMessageDialog CreateMessageDialog(string message, DialogMode dialogMode, System.Windows.MessageBoxImage image = MessageBoxImage.None)
		{
			...
			InvokeInUIThread(() =>
			{
				dialog = new MessageDialog(_dialogHost, dialogMode, message, _dispatcher, image);
			});
			return dialog;
		}
        ...
        public IProgressDialog CreateProgressDialog(DialogMode dialogMode, bool isIndeterminate = false)
		{
			...
			InvokeInUIThread(() =>
			{
                dialog = WaitProgressDialog.CreateProgressDialog(_dialogHost, dialogMode, _dispatcher, isIndeterminate);
		...
		public IWaitDialog CreateWaitDialog(DialogMode dialogMode, bool isIndeterminate = false)
		{
			...
			InvokeInUIThread(() =>
			{
				dialog = WaitProgressDialog.CreateWaitDialog(_dialogHost, dialogMode, _dispatcher, isIndeterminate);
				dialog.CloseWhenWorkerFinished = true;
			});
			return dialog;
		}
