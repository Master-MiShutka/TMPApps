...
{
    public partial class InputDialog : BaseTMPDialog
    {
        internal InputDialog(TMPWindow parentWindow)
        ...
        public static readonly DependencyProperty NegativeButtonTextProperty = DependencyProperty.Register("NegativeButtonText", typeof(string), typeof(InputDialog), new PropertyMetadata("Отменить"));
