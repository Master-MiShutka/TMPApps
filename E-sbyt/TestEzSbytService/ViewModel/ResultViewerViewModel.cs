    ...
    public class ResultViewerViewModel : ViewModel.AbstractViewModel
    {
        ...
        public ResultViewerViewModel()
        {
            ...
            ViewContentInNewWindowCommand = new DelegateCommand(
                () =>
                {
                    ...
                    window.Content = GetViewerControl();
            ...
            ViewContentAsTableCommand = new DelegateCommand(
                () =>
                {
                    View.TableWindow table = new View.TableWindow()
                    {
                        Source = DataView,
                        ShowInTaskbar = true,
                        ShowActivated = true,
                ...
                (param) => Data.HasData && DataView != null,
                "Как таблицу");
            ...
            ExportCommand = new DelegateCommand(
               () =>
               {
                   ...
                   try
                   {
                       success = DataAccess.Export.ToExcelFromDataView(DataView);
                   }
                   catch (Exception e)
                   {
                       App.LogException(e);
        ...
        private void InitDataView()
        {
            ...
            if (SelectedFormatType == FormatTypes.json)
                DataView = DataAccess.Export.ToDataViewFromJson(_data.ResultAsString);
            if (SelectedFormatType == FormatTypes.text || SelectedFormatType == FormatTypes.native || SelectedFormatType == FormatTypes.webview)
                DataView = DataAccess.Export.ToDataViewFromValueTable(_data.ResultAsString);
        }
