        ...
        public static ClearTypeLetterGlyph CreateGlyph(GlyphTypeface glyphTypeface, System.Drawing.Font font, double size, char ch, System.Windows.Media.Color fontColor, System.Windows.Media.Color bgColor)
        {
            ...
            using (var bmp1 = new Bitmap(1, 1, System.Drawing.Imaging.PixelFormat.Format32bppPArgb))
            {
                using (var g = Graphics.FromImage(bmp1))
                {
                    ...
                    var sizef = g.MeasureString(string.Empty + ch, font, new PointF(0, 0), StringFormat.GenericTypographic);
            ...
            using (var bmp = new System.Drawing.Bitmap(width, height, System.Drawing.Imaging.PixelFormat.Format32bppPArgb))
            {
                ...
                using (var g = System.Drawing.Graphics.FromImage(bmp))
                {
                    ...
                    g.DrawString(string.Empty + ch, font, new System.Drawing.SolidBrush(fg2), 0, 0, StringFormat.GenericTypographic);
                }
                    ...
                    for (int x = 0; x < width; x++)
                    {
                        ...
                        if (color != bg2)
                        {
                            res.Add(new Item
                            {
                                X = (short)x,
                                Y = (short)y,
                                Color = WriteableBitmapExtensions.ConvertColor(System.Windows.Media.Color.FromArgb(color.A, color.R, color.G, color.B)),
                            });
                        }
                    }
                }
