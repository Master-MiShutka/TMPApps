...
namespace EPPlusSamples
{
    ...
    public static class Sample12
    {
        public class SalesDTO
        {
            ...
            public string Name => string.IsNullOrEmpty(this.MiddleName) ? this.FirstName + " " + this.LastName : this.FirstName + " " + this.MiddleName + " " + this.LastName;
            ...
            public decimal Total => this.SubTotal + this.Tax + this.Freight;
        }
