...
{
    /// <summary>
    /// A TMPfied ProgressBar.
    /// <see cref="ProgressBar"/>
    /// </summary>
    public class TMPProgressBar : ProgressBar
    {
        public static readonly DependencyProperty EllipseDiameterProperty =
            DependencyProperty.Register("EllipseDiameter", typeof(double), typeof(TMPProgressBar),
                                        new PropertyMetadata(default(double)));

        public static readonly DependencyProperty EllipseOffsetProperty =
            DependencyProperty.Register("EllipseOffset", typeof(double), typeof(TMPProgressBar),
                                        new PropertyMetadata(default(double)));

        private Storyboard indeterminateStoryboard;

        static TMPProgressBar()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(TMPProgressBar), new FrameworkPropertyMetadata(typeof(TMPProgressBar)));
            IsIndeterminateProperty.OverrideMetadata(typeof(TMPProgressBar), new FrameworkPropertyMetadata(OnIsIndeterminateChanged));
        }

        public TMPProgressBar()
        {
        ...
        {
            var bar = dependencyObject as TMPProgressBar;
