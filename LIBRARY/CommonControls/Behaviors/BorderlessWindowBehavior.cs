...
namespace TMP.Wpf.CommonControls.Behaviors
{
    ...
    public class BorderlessWindowBehavior : Behavior<Window>
    {
        ...
        protected override void OnAttached()
        {
            ...
            var TMPWindow = AssociatedObject as TMPWindow;
            if (TMPWindow != null)
            {
                windowChrome.IgnoreTaskbarOnMaximize = TMPWindow.IgnoreTaskbarOnMaximize;
                windowChrome.UseNoneWindowStyle = TMPWindow.UseNoneWindowStyle;
                System.ComponentModel.DependencyPropertyDescriptor.FromProperty(TMPWindow.IgnoreTaskbarOnMaximizeProperty, typeof(TMPWindow))
                      .AddValueChanged(AssociatedObject, IgnoreTaskbarOnMaximizePropertyChangedCallback);
                System.ComponentModel.DependencyPropertyDescriptor.FromProperty(TMPWindow.UseNoneWindowStyleProperty, typeof(TMPWindow))
        ...
        {
            var TMPWindow = sender as TMPWindow;
            if (TMPWindow != null && windowChrome != null)
            {
                if (!Equals(windowChrome.UseNoneWindowStyle, TMPWindow.UseNoneWindowStyle))
                {
                    windowChrome.UseNoneWindowStyle = TMPWindow.UseNoneWindowStyle;
        ...
        private void IgnoreTaskbarOnMaximizePropertyChangedCallback(object sender, EventArgs e)
        {
            ...
            if (TMPWindow != null && windowChrome != null)
            {
                if (!Equals(windowChrome.IgnoreTaskbarOnMaximize, TMPWindow.IgnoreTaskbarOnMaximize))
                {
                    windowChrome.IgnoreTaskbarOnMaximize = TMPWindow.IgnoreTaskbarOnMaximize;
                    this.ForceRedrawWindowFromPropertyChanged();
                }
        ...
        private void Cleanup()
        {
            if (!isCleanedUp)
            {
                ...
                // clean up events
                if (AssociatedObject is TMPWindow)
                {
                    System.ComponentModel.DependencyPropertyDescriptor.FromProperty(TMPWindow.IgnoreTaskbarOnMaximizeProperty, typeof(TMPWindow))
        ...
        private IntPtr WindowProc(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam, ref bool handled)
        {
            ...
            switch (msg)
            {
                case Constants.WM_NCPAINT:
                    ...
                    if (TMPWindow != null)
                    {
                        enableDWMDropShadow = TMPWindow.GlowBrush == null && (TMPWindow.EnableDWMDropShadow || EnableDWMDropShadow);
                    }
            ...
            if (AssociatedObject.WindowState == WindowState.Maximized)
            {
                ...
                if (ignoreTaskBar)
                {
                    ...
                    if (monitor != IntPtr.Zero)
                    {
                        ...
                        //ignoreTaskBar = TMPWindow.IgnoreTaskbarOnMaximize || TMPWindow.UseNoneWindowStyle;
        ...
        {
            var window = sender as TMPWindow;
            if (window == null)
            {
                return;
            }
