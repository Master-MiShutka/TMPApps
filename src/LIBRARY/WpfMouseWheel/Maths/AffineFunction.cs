namespace WpfMouseWheel.Maths
{
    public class AffineFunction
    {
        ...
        public AffineFunction(double ax, double ay, double bx, double by)
        {
            ...
            this.YIntercept = ay - (this.Slope * ax);
        }
        ...
        public double XIntercept => this.X(0);
        ...
        public AffineFunction SetXIntercept(double value)
        {
            return this.SetYIntercept(-this.Slope * value);
        }
