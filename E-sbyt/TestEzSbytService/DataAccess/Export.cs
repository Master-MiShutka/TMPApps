...
namespace TMP.Work.AmperM.TestApp.DataAccess
{
  public class Export
  {
    ...
    public static bool? CreateExcelWorkBookFromCollection(IEnumerable<dynamic> source, 
      bool printHeaders = true, string bookFileName = null)
    {
      ...
      try
      {
        ...
        using (OfficeOpenXml.ExcelPackage pck = new OfficeOpenXml.ExcelPackage())
        {
          ...
          ws.Cells["A1"].LoadFromCollection(source, printHeaders, OfficeOpenXml.Table.TableStyles.Medium16);
          pck.SaveAs(fi);
        }
      }
      catch (Exception e)
