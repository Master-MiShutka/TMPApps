...
namespace Xceed.Wpf.DataGrid.Export
{
    public abstract class ClipboardExporterBase
    {
        ...
        protected virtual void StartHeaderField(DataGridContext dataGridContext, Column column, bool isFirst, bool isLast)
        {
        }

        protected virtual void EndHeaderField(DataGridContext dataGridContext, Column column, bool isFirst, bool isLast)
        {
        }
        ...
        protected virtual void StartDataItemField(DataGridContext dataGridContext, Column column, object fieldValue, bool isFirst, bool isLast)
        {
        }

        protected virtual void EndDataItemField(DataGridContext dataGridContext, Column column, object fieldValue, bool isFirst, bool isLast)
        {
        }
        ...
        internal static void CreateDataObjectAndClipboardSet(DataGridControl dataGridControl)
        {
            if (dataGridControl == null)
                throw new ArgumentNullException("dataGridControl");
        ...
        private class ManualExporter : IDisposable
        {
            ...
            internal void Export(DataGridContext dataGridContext)
            {
                ...
                List<int> indexesToMasterItemList = dataGridContext.CustomItemContainerGenerator.GetMasterIndexexWithExpandedDetails();
                                             ...
                                             ColumnBase[] columnsByVisiblePosition)
            {
                ...
                for (int i = 0; i < exportedVisiblePositionsCount; i++)
                {
                    ...
                    clipboardExporter.StartDataItemField(dataGridContext, column, fieldValue, i == 0, i == exportedVisiblePositionsCount - 1);
                    clipboardExporter.EndDataItemField(dataGridContext, column, fieldValue, i == 0, i == exportedVisiblePositionsCount - 1);
                }
                                            ...
                                            ColumnBase[] columnsByVisiblePosition)
            {
                ...
                for (int i = 0; i < exportedVisiblePositionsCount; i++)
                {
                    ...
                    clipboardExporter.StartHeaderField(dataGridContext, column, i == 0, i == exportedVisiblePositionsCount - 1);
                    clipboardExporter.EndHeaderField(dataGridContext, column, i == 0, i == exportedVisiblePositionsCount - 1);
                }
