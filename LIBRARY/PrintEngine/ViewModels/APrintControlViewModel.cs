...
namespace TMP.PrintEngine.ViewModels
{
    public abstract class APrintControlViewModel : AViewModel, IViewModel
    {
        ...
        public void ShowProgressDialog()
        {
            ...
            ProgressDialog.DialogTitle = TMP.PrintEngine.Resources.Strings.Printing;
            ProgressDialog.CancelButtonCaption = TMP.PrintEngine.Resources.Strings.CancelButtonCaption;
        ...
        public string GetStatusMessage()
        {
            return string.Format("{0} {1} / {2}", TMP.PrintEngine.Resources.Strings.PrintingPages, 
                ProgressDialog.CurrentProgressValue, ProgressDialog.MaxProgressValue);
        }
        ...
        public void CreatePrintPreviewWindow()
        {
            ...
            FullScreenPrintWindow.Title = TMP.PrintEngine.Resources.Strings.PrintPreview;
