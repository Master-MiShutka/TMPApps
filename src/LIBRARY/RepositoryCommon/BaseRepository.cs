namespace TMP.Common.RepositoryCommon
{
    ...
    public class BaseRepository<T, TDataFileInfo> : Shared.Common.PropertyChangedBase, IDisposable
        ...
        where TDataFileInfo : class, IDataFileInfo, new()
    {
        ...
        public BaseRepository(string dataStorePath = default)
        {
            ...
            BindingOperations.EnableCollectionSynchronization(this.availableDataFiles, new object());
