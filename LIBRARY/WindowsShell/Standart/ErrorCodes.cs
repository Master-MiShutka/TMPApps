namespace Standard
{
    ...
    public struct HRESULT
    {
        ...
        /// </summary>
        public Facility Facility => GetFacility((int)this.value);
        ...
        /// </summary>
        public int Code => GetCode((int)this.value);
        ...
        #endregion Object class override members
        ...
        public bool Succeeded => (int)this.value >= 0;

        public bool Failed => (int)this.value < 0;
        ...
        [SuppressMessage(
                "Microsoft.Security",
                "CA2122:DoNotIndirectlyExposeMethodsWithLinkDemands", Justification = "ToDo")]
