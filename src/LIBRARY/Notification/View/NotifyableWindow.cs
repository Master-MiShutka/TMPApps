namespace UserNotification.View
{
    ...
    public partial class NotifyableWindow : Window
    {
        ...
        private readonly NotificationWindow notificationWindow = null;
                ...
                : base()
        {
            ...
            this.DataContextChanged += this.MsgBoxView_DataContextChanged;
            this.Loaded += this.OnMsgBoxView_Loaded;
            this.Unloaded += this.NotifyableWindow_Unloaded;
        }
        ...
        protected void MsgBoxView_DataContextChanged(object sender, System.Windows.DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                this.mViewModel.ShowNotificationMessage -= this.ViewModel_ShowNotificationMessage;
            }
