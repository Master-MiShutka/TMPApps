...
namespace Microsoft.WindowsAPICodePack.Dialogs
{
    ...
    public class CommonFileDialogFilter
    {
            ...
            : this()
        {
            ...
            {
                this.extensions.Add(CommonFileDialogFilter.NormalizeExtension(extension));
            }
        }
        ...
        /// </summary>
        public Collection<string> Extensions => this.extensions;
        ...
        {
            get => this.showExtensions;
            set => this.showExtensions = value;
        }
        ...
        internal ShellNativeMethods.FilterSpec GetFilterSpec()
        {
            ...
            return new ShellNativeMethods.FilterSpec(this.DisplayName, filterList.ToString());
        }
