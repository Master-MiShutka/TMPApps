...
namespace WpfDialogManagement
{
	abstract class DialogBase : IDialog, INotifyPropertyChanged
	{
			...
			Dispatcher dispatcher)
		{
			...
			OkText = Local.Strings.OK_Button_Label;
			CancelText = Local.Strings.Cancel_Button_Label;
			YesText = Local.Strings.Yes_Button_Label;
			NoText = Local.Strings.No_Button_Label;
