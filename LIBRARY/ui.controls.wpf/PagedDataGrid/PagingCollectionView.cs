...
namespace TMP.UI.Controls.WPF
{
    ...
    public class PagingCollectionView : ListCollectionView
    {
            ...
            : base(list)
        {
            ...
            () => base.InternalList != null && _itemsPerPage < base.InternalCount);
            ...
            () => base.InternalList != null && UICurrentItemPositionOnPage > 1);
            ...
            _moveToNextCommand = new DelegateCommand(() =>
            {
                ...
                if (IsCurrentAfterLast)
                    MoveCurrentToLast();
            }, () => base.InternalList != null && !IsCurrentAfterLast && UICurrentItemPositionOnPage < Count);
