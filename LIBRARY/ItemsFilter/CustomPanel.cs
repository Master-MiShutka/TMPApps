...
namespace ItemsFilter
{
    ...
    public class ColumnedPanel : Panel
    {
        ...
        public static void SetColumnBreakAfter(UIElement element, Boolean value)
        {
            element.SetValue(ColumnBreakAfterProperty, value);
        }
        public static Boolean GetColumnBreakAfter(UIElement element)
        {
        ...
        protected override Size ArrangeOverride(Size arrangeBounds)
        {
            ...
            for (int i = 0; i < elements.Count; i++)
            {
                ...
                if (breakAfter)
                {
                    ...
                    ArrangeColumn(accumulatedWidth, currentColumnSize.Width, firstInLine, i + 1, arrangeBounds);
