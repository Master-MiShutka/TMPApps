namespace UIInfrastructure.Contracts
{
    ...
    {
        IMessageDialog? CreateMessageDialog(string message, DialogMode dialogMode, MessageBoxImage image);

        IMessageDialog? CreateMessageDialog(string message, string caption, DialogMode dialogMode, MessageBoxImage image);
